...
class LibvirtWrapper:
    ...
    async def list_vms(self, ssh_conn: SSHConnection, 
                      status_filter: Optional[str] = None) -> List[VMInfo]:
        """List VMs on a host."""
        try:
        ...
        try:
            ...
            for disk_elem in root.findall(".//disk[@type='file']"):
                ...
                if source is not None and target is not None:
                    ...
                    disk_format = driver.get("type", "raw") if driver is not None else "raw"
            ...
            for interface_elem in root.findall(".//interface"):
                ...
                if mac_elem is not None:
                    ...
                    if source_elem is not None:
                        network_name = source_elem.get("network", source_elem.get("bridge", ""))
    ...
    async def clone_vm_definition(self, ssh_conn: SSHConnection, source_vm: str, 
                                target_vm: str, preserve_mac: bool = False) -> str:
    ...
    async def create_vm_from_xml(self, ssh_conn: SSHConnection, xml_config: str) -> None:
