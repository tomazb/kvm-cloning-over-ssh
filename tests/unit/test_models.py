...
class TestNetworkInfo:
    ...
    def test_network_info_creation(self):
        ...
        network = NetworkInfo(
            interface="eth0", mac_address="52:54:00:12:34:56", network="default"
        )
    ...
    def test_network_info_mac_address_format(self):
        ...
        macs = ["52:54:00:12:34:56", "52-54-00-12-34-56", "525400123456"]
        for mac in macs:
...
class TestResourceInfo:
    ...
    def test_resource_info_calculations(self):
        ...
        mem_usage = (
            (info.total_memory - info.available_memory) / info.total_memory
        ) * 100
